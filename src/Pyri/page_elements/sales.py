...
class sales_elements:
        def sales_ele(self,frame,home):
                ...
                self.new_sale_button=ui.Button(frame,text="Add customer",command = lambda : None ,width=30,font=("Arial",10,"bold"))
                self.new_sale_button.place(relx=0.02,rely=0.05)
                
                self.sale_new_cus_button=ui.Button(frame,text="New Sale",command = lambda : None,width=30,font=("Arial",10,"bold"))
